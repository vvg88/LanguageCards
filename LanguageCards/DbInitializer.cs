...
namespace LanguageCards.Data.Models
{
    static class DbInitializer
    {
        ...
        private static void AddCard(CardsDb contxt, string txt, Language lang, WordClass wClass, string defStr, string examp, IEnumerable<Word> translations)
        {
