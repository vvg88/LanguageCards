        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpeechPartId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Words_SpeechParts_SpeechPartId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WordsTranslations", x => new { x.WordId, x.TranslationId });
                    table.ForeignKey(
                        name: "FK_WordsTranslations_Words_TranslationId",
                        column: x => x.TranslationId,
                        principalTable: "Words",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WordsTranslations_Words_WordId",
                        column: x => x.WordId,
                        principalTable: "Words",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxScore = table.Column<int>(nullable: false, defaultValue: 5),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CardProgresses_Statuses_CardStatusId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CardProgresses_CardStatusId",
                table: "CardProgresses",
                column: "CardStatusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WordsTranslations_TranslationId",
